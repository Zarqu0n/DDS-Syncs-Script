...
/*         udp_transport->sendBufferSize = 9216;
        ...
        wqos.resource_limits().allocated_samples = 1; // aynı anda bellekte tutulabilecek veri sayısı
...
int main()
{
    std::string Publisher_topic_name = "Machine2";
    std::string Subscriber_topic_name = "Machine1";

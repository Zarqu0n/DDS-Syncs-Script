...
KeyValue::KeyValue()
{
    // m_key com.eprosima.idl.parser.typecode.StringTypeCode@30ee2816
    m_key ="";
    // m_value com.eprosima.idl.parser.typecode.StringTypeCode@5c30a9b0
    m_value ="";
...
size_t KeyValue::getMaxCdrSerializedSize(
...
size_t KeyValue::getCdrSerializedSize(
        const KeyValue& data,
        size_t current_alignment)
{
    (void)data;
...
size_t KeyValue::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
bool KeyValue::isKeyDefined()
{
    return false;
}

void KeyValue::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
